...
window.GUN_ATLAS_DATA = {
  ...
  customNames: {
    ja: {
      XKX: "コソボ", TWN: "台湾", ARE: "アラブ首長国連邦", SWZ: "エスワティニ",
      COD: "コンゴ民主共和国", COG: "コンゴ共和国", MMR: "ミャンマー", PSE: "パレスチナ",
    },
    en: {
      XKX: "Kosovo", TWN: "Taiwan", CZE: "Czechia", SWZ: "Eswatini",
      COD: "Democratic Republic of the Congo", COG: "Republic of the Congo", MMR: "Myanmar", PSE: "Palestine",
  ...
  officialSources: {
    ...
    JPN: "https://laws.e-gov.go.jp/document?lawid=333AC0000000006",
    USA: "https://www.atf.gov/firearms",
  },

  wikipediaSections: {
    AFG: "Afghanistan", ARE: "United_Arab_Emirates", ARG: "Argentina", AUS: "Australia",
    AUT: "Austria", BEL: "Belgium", BGD: "Bangladesh", BIH: "Bosnia_and_Herzegovina",
    BLZ: "Belize", BRA: "Brazil", BRN: "Brunei", BWA: "Botswana",
    CAF: "Central_African_Republic", CAN: "Canada", CHE: "Switzerland", CHL: "Chile",
    CHN: "China", COL: "Colombia", CRI: "Costa_Rica", CUB: "Cuba",
    CYP: "Cyprus", CZE: "Czech_Republic", DEU: "Germany", DJI: "Djibouti",
    DNK: "Denmark", EGY: "Egypt", ERI: "Eritrea", ESP: "Spain",
    EST: "Estonia", FIN: "Finland", FRA: "France", GBR: "United_Kingdom_(Except_Northern_Ireland)",
    GEO: "Georgia", GHA: "Ghana", GMB: "Gambia", GRC: "Greece",
    ...
    KEN: "Kenya", KHM: "Cambodia", KOR: "South_Korea", KWT: "Kuwait",
    LBN: "Lebanon", LBR: "Liberia", LIE: "Switzerland", LSO: "Lesotho",
    LTU: "Lithuania", LUX: "Luxembourg", MCO: "Monaco", MEX: "Mexico",
    MKD: "North_Macedonia", MLT: "Malta", MMR: "Myanmar", MNG: "Mongolia",
    MOZ: "Mozambique", MYS: "Malaysia", NAM: "Namibia", NLD: "Netherlands",
    NOR: "Norway", NPL: "Nepal", NZL: "New_Zealand", PAK: "Pakistan",
    PAN: "Panama", PHL: "Philippines", POL: "Poland", PRK: "North_Korea",
    PRY: "Paraguay", ROU: "Romania", RUS: "Russia", RWA: "Rwanda",
    SEN: "Senegal", SGP: "Singapore", SLE: "Sierra_Leone", SLV: "El_Salvador",
    SOM: "Somalia", SRB: "Serbia", SVK: "Slovakia", SVN: "Slovenia",
    SWE: "Sweden", SWZ: "Eswatini", SYR: "Syria", TCD: "Chad",
    THA: "Thailand", TLS: "Timor-Leste", TUR: "Turkey", TWN: "Taiwan",
    UKR: "Ukraine", URY: "Uruguay", USA: "United_States", UZB: "Uzbekistan",
    VEN: "Venezuela", VNM: "Vietnam", YEM: "Yemen", ZAF: "South_Africa",
  },

  markers: {
    AND: [1.6, 42.5], ATG: [-61.8, 17.1], BHR: [50.6, 26.1], BRB: [-59.5, 13.2],
    CPV: [-23.6, 15.1], COM: [43.3, -11.7], DMA: [-61.4, 15.4], FSM: [158.2, 6.9],
    GRD: [-61.7, 12.1], KIR: [173.0, 1.4], KNA: [-62.8, 17.3], LCA: [-61.0, 13.9],
